#Matriz de costos
costo = [[-1,513,507,1190,1100,1150,1280,1230,1120,1270,1030,1000,962],
...
lugares = [[0,"Sam's club (almacén)"],
         [1,"Food & Friends"],
         [2,"La Condesa Brunch"],
         [3,"Cafezzito"],
         [4,"KAPÚ"],
         [5,"Sushi y Así Rufino"],
         [6,"Capricciosas Rufino Tamayo"],
         [7,"La Cipolla"],
         [8,"Broxton Burgers & Beers"],
         [9,"Dairy Queen"],
         [10,"La Barda"],
         [11,"Nikkori"],
         [12,"Burritos los originales uane"]]